package com.tong.copilotdemo.util;
...
public class HttpUtils {
    ...
    public static Optional<String> httpGet(String url) throws IOException {
        ...
        httpGet.setHeader(HttpHeaders.AUTHORIZATION, "Basic " + Base64.encodeBase64String(StringUtils.joinWith(":", Constant.CLIENT_ID, Constant.CLIENT_SECRET).getBytes()));
    ...
    public static Optional<String> httpPost(String url, String content) throws IOException {
        ...
        httpPost.setHeader(HttpHeaders.AUTHORIZATION, "Basic " + Base64.encodeBase64String(StringUtils.joinWith(":", Constant.CLIENT_ID, Constant.CLIENT_SECRET).getBytes()));
